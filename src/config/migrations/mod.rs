...
pub mod v002_service_discovery;
    ...
    fn all_migrations(&self) -> Vec<Box<dyn MigrationEntry>> {
        vec![
            ...
            Box::new(MigrationEntryV002(
                v002_service_discovery::V002ServiceDiscovery,
            )),
        ]
    }
...
/// Wrapper for V002ServiceDiscovery.
struct MigrationEntryV002(v002_service_discovery::V002ServiceDiscovery);
